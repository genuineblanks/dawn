      ...
      switch (actionType) {
        ...
        case 'edit-garment':
          ...
          if (element.getAttribute('data-garment-id')) {
            // Sample Flow - navigate back to Step 3A
            if (window.TechPackV11 && window.TechPackV11.Navigation) {
              console.log('[Actions] Sample: Navigating back to Step 3A to edit garment');
        ...
        case 'delete-garment':
          // Check which flow: Sample (Step3B) or Quotation (Garments)
          if (element.getAttribute('data-garment-id')) {
            // Sample Flow - delete from Step3B garments array
