...
class V10_GarmentUIManager {
  ...
  updateSelectionDependencies(garmentCard, garmentData) {
    ...
    // Enable/disable sample selection based on fabric type
    if (garmentData.fabricType) {
...
class V10_GarmentManager {
  ...
  duplicateGarment(sourceId) {
    try {
      ...
      // Create duplicate data (new ID, no assignments, but preserve specifications)
      const duplicateData = {
        ...
        includeDesign: sourceGarment.includeDesign,
        designReference: sourceGarment.designReference,
...
class V10_GarmentStudio {
  ...
  handleGarmentChanges(e) {
    ...
    if (e.target.classList.contains('design-toggle__input')) {
      ...
      // Apply three-state color feedback
  ...
  handleGarmentKeyDown(e) {
    // Handle Enter key press on design reference input
    if (e.key === 'Enter' && e.target.classList.contains('design-reference__input')) {
      e.preventDefault();
      ...
      // Validate that input has content
      if (inputValue.length === 0) {
        // Show validation warning if input is empty
      ...
      // Update garment data with the design reference value
  ...
  updateToggleColors(garmentCard, garmentData) {
    ...
    const toggleText = garmentCard.querySelector('.design-toggle__text');
    const toggleContainer = garmentCard.querySelector('.design-toggle-header') || 
                           garmentCard.querySelector('[class*="toggle"]') ||
                           (toggleText ? toggleText.parentElement : null);
    
    if (!toggleContainer || !toggleText) {
      console.log('⚠️ Toggle elements not found for color update');
      return;
    }
    
    // Remove all color classes and click handler
  ...
  updateCompactSelection(type, value, garmentCard, subValue = null, isInitialSet = false) {
    ...
    if (stockSection || customSection) {
      if (hasGarmentType && hasFabricType) {
        // Enable sample type compact selection sections
        if (stockSection) {
          stockSection.classList.remove('compact-selection-section--disabled');
        ...
        if (stockSection) {
          ...
          this.disableSelectionSection(stockSection, disabledMessage);
        }
        if (customSection) {
          customSection.classList.add('compact-selection-section--disabled');
          this.disableSelectionSection(customSection, disabledMessage);
        }
      }
    }
  ...
  getGarmentIcon(garmentType) {
    ...
    const iconMap = {
      'Zip-Up Hoodie': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M20.38 3.46L16 2a4 4 0 0 1-8 0l-4.38 1.46a2 2 0 0 0-1.49 2.28l.5 3C2.78 9.66 3 10.26 3 11v9a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-9c0-.74.22-1.34.37-2.26l.5-3a2 2 0 0 0-1.49-2.28z"/><path d="M12 4v4"/></svg>',
      'Hoodie': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M20 3H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2z"/><path d="M7 3v4l5-4 5 4V3"/><circle cx="12" cy="12" r="2"/></svg>',
      ...
      'Sweatshirt': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M21 8.5l-2-1-1.5-6.5H6.5L5 7.5l-2 1L3 12l2 .5V21h14v-8.5l2-.5z"/></svg>',
      'Sweatpants': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M8 2v20l4-2 4 2V2"/><path d="M8 8h8"/><path d="M8 14h8"/></svg>',
      'Shorts': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M8 2v12l4-2 4 2V2"/><path d="M8 8h8"/></svg>',
      'Long Sleeve T-Shirt': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M20.38 3.46L16 2a4 4 0 0 1-8 0l-4.38 1.46a2 2 0 0 0-1.49 2.28l.5 3C2.78 9.66 3 10.26 3 11v9a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-9c0-.74.22-1.34.37-2.26l.5-3a2 2 0 0 0-1.49-2.28z"/><path d="M4 8h16"/></svg>',
      'Shirt': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M20.38 3.46L16 2a4 4 0 0 1-8 0l-4.38 1.46a2 2 0 0 0-1.49 2.28l.5 3C2.78 9.66 3 10.26 3 11v9a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-9c0-.74.22-1.34.37-2.26l.5-3a2 2 0 0 0-1.49-2.28z"/><circle cx="8" cy="6" r="1"/><circle cx="16" cy="6" r="1"/></svg>',
  ...
  getSampleReferenceIcon(referenceType) {
    const iconMap = {
      'approved-sample': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M9 12l2 2 4-4"/><circle cx="12" cy="12" r="10"/></svg>',
      'approved-with-changes': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M3 21v-5h5"/></svg>',
      'new-sample-version': '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>'
    };
    return iconMap[referenceType] || '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>';
  }
  ...
  saveCurrentQuantitiesToState() {
    ...
    quantityInputs.forEach(input => {
      ...
      if (!garmentId || !size) return;
      
      // Ensure garment data exists in quantities state
      ...
      const quantityData = V10_State.quantities.garments.get(garmentId);
      quantityData.sizes[size] = value;
      
      // Recalculate total for this garment
      quantityData.total = Object.values(quantityData.sizes).reduce((sum, qty) => sum + qty, 0);
    });
  ...
  restoreQuantitiesFromState() {
    // Restore saved quantities to the DOM inputs
    V10_State.quantities.garments.forEach((quantityData, garmentId) => {
      ...
      Object.entries(quantityData.sizes).forEach(([size, quantity]) => {
        const input = garmentCard.querySelector(`[data-size="${size}"]`);
        if (input && quantity > 0) {
