  ...
  class TechPackApp {
    ...
    populateClientReview() {
      ...
      content.innerHTML = `
        ...
        ${client.requestType ? `
          <div class="review-item">
            <div class="review-item__label">Request Type</div>
            <div class="review-item__value">${client.requestType === 'sample-request' ? 'Sample Request' : client.requestType === 'bulk-order-request' ? 'Bulk Order Request' : client.requestType}</div>
          </div>
        ` : ''}
        ${client.notes ? `
          <div class="review-item">
