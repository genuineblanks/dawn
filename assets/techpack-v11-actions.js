  ...
  const Navigation = {
    ...
    handleAction: function(actionType, element, event) {
      ...
      switch (actionType) {
        ...
        case 'update-assign-button-state':
          if (window.TechPackV11.ColorStudio) {
            window.TechPackV11.ColorStudio.updateAssignButtonState();
          }
          break;

        case 'assign-color-to-garment':
          if (window.TechPackV11.ColorStudio) {
            window.TechPackV11.ColorStudio.assignColorToGarment();
          }
          break;
