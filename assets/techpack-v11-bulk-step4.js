...
(function() {
  ...
  window.TechPackV11.BulkStep4 = {
    ...
    /**
     * Clear colorway from garment (and return Pantone to Lab Dip Cart if applicable)
     */
    deleteColorway: function(garmentId) {
      ...
      if (confirm(`Delete ${garment.colorway.color} colorway?`)) {
        ...
        if (garment.colorway.colorType === 'pantone' && garment.colorway.pantoneColor) {
          console.log('[BulkStep4] Returning Pantone color to Lab Dip Cart:', garment.colorway.pantoneColor);
    ...
    assignTechPackReference: function(garmentId) {
      ...
      this.collapseAllExpansions();
      console.log('[BulkStep4] Assigned TechPack reference:', name, hex, 'to garment', garmentId);
    },
    ...
    renderLabDipCart: function() {
      ...
      if (totalEl) {
        ...
        totalEl.textContent = hasItems ? `Total: €${total.toFixed(2)}` : 'Total: €0.00';
      }
