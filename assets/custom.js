...
function initializeScrollSystem() {
  ...
  waitForFooterLoad(function() {
    calculateSectionPositions();

    // Continue with initialization after positions are calculated
    initializeScrollSystemContinued();
  });
}

function initializeScrollSystemContinued() {
...
waitForJQuery(function() {
  ...
  function waitForFooterLoad(callback) {
    ...
    // If footer doesn't exist, wait for it with timeout
    let checkCount = 0;
    ...
    const checkInterval = setInterval(function() {
      ...
      if (footer || checkCount >= maxChecks) {
        ...
        // Small delay after footer appears to ensure it's fully rendered
