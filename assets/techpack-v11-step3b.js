            ...
            <div class="garment-color-card__content">
              ...
              <div class="garment-color-card__color-display">
                ...
                ${garment.colorType === 'pantone' ? `
                  ...
                  <button type="button" class="garment-color-btn garment-color-btn--danger" data-action="delete-garment-color" data-garment-id="${garment.id}">
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                      <path d="M1.75 3.5h10.5M4.375 3.5V2.333a1.167 1.167 0 0 1 1.167-1.166h2.916a1.167 1.167 0 0 1 1.167 1.166V3.5m1.75 0v8.167a1.167 1.167 0 0 1-1.167 1.166H4.083a1.167 1.167 0 0 1-1.166-1.166V3.5h8.166Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Delete
                  </button>
                ` : `
